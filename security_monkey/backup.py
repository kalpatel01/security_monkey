...
"""
from security_monkey.monitors import get_watchers
...
def backup_config_to_json(account_names, monitor_names, output_folder):
    watchers = get_watchers(account_names, monitor_names)
    for watcher in watchers:
        for account in account_names:
            _backup_items_in_account(account, watcher, output_folder)
